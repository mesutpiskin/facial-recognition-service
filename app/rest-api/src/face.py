...
class Face:
    ...
    def recognize(self, unknown_filename):
        ...
        if not known_face_name_list_local:
            ...
            return  {'ids':None, 'locations':None, 'image':None}
        ...
        # image frame
        cvframe = cv2.imread(unknown_filename)
        ...
        if not face_locations:
           ...
           return  {'ids':[], 'locations':[], 'image':None}
        ...
        for face_encoding in face_encodings:
            ...
            name = "unknown"  # default name is not recognized
        ...
        result = {'ids':face_names, 'locations':face_locations, 'image':str(jpg_as_text)}
        return result
